...
class AppTheme {
  ...
  static TextTheme _textTheme(Brightness brightness) {
    ...
    return base.copyWith(
      ...
      displayMedium: base.displayMedium?.copyWith(fontWeight: FontWeight.w700, letterSpacing: -0.4),
  ...
  static ThemeData _decorate(ThemeData base) {
    ...
    final outline = base.colorScheme.outline.withValues(alpha: isDark ? 0.4 : 0.6);
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: base.textTheme.bodyMedium?.copyWith(color: base.colorScheme.onSurface.withValues(alpha: 0.7)),
        hintStyle: base.textTheme.bodyMedium?.copyWith(color: base.colorScheme.onSurface.withValues(alpha: 0.45)),
      ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: base.textTheme.bodyMedium?.copyWith(color: base.colorScheme.surface),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: base.textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w500),
        side: BorderSide(color: outline),
